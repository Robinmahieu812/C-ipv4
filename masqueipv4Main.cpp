...
long int IPG0;
    ...
    {
        TextCtrl4->SetValue(tab[CIDR-1].masque);
...
if (i>32){
    TextCtrl7->SetValue(wxString::Format(wxT("%d"),tab[i].masque));
    TextCtrl5->SetValue(wxString::Format(wxT("%s"),tab[i].masque_inv));
    TextCtrl6->SetValue(wxString::Format(wxT("%d"),tab[i].nbmachine));
}
